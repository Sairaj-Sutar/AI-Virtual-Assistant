...
# #
# # #image
# # image=ImageTk.PhotoImage(Image.open("assets/logoAI.jpg"))
...
#
#     image_label = Label(Main_frame, image=image, bg="#6F8FAF")
...
#                  pady=16, padx=40, borderwidth=3, relief=SOLID, command=User_send)
# button2.place(x=520, y=595)
#
# button3 = Button(root, text="Delete", bg="#356696", fg="white",
#                  pady=16, padx=40, borderwidth=3, relief=SOLID, command=delete_text)
# button3.place(x=800, y=595)
#
# root.mainloop()
